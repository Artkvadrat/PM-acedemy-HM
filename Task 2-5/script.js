...
startData.sort((a, b) => {
    return Date.parse(b.registrationDate.slice(5, 20) + b.registrationDate.slice(21, 24) + b.registrationDate.slice(25, 27)) -
            Date.parse(a.registrationDate.slice(5, 20) + a.registrationDate.slice(21, 24) + a.registrationDate.slice(25, 27));
});
